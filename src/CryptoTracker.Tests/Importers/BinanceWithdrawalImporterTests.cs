...
public class BinanceWithdrawalImporterTests : DbTestBase
{
    ...
    private const string Csv = "Date(UTC);Coin;Network;Amount;TransactionFee;Address;TXID;Status;Comment\n" +
    ...
    public async Task ImportCreatesWithdrawal()
    {
        ...
        tx.DateTime.Should().Be(new DateTimeOffset(2018, 2, 2, 9, 14, 0, TimeSpan.Zero));
